...
public class PanelPaciente extends Panel {
    ...
    public PanelPaciente(Controlador c) {
        ...
        JPanel barraUsuario = crearBarraUsuario(TipoUsuario.PACIENTE);
        ...
        panelCentral.add(new PanelPacienteHistorial(c.getLoginPaciente(), controlador), BorderLayout.CENTER);
        crearBotonera();
    }
